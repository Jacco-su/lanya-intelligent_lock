            ...
            <div class="easyui-panel" title="变电站->门锁" style="width:800px" id="stepThere">
                <div style="padding:10px 60px 20px 60px">
                    <table cellpadding="5">
                        <tr>
                            <td colspan="3">
                                <table class="easyui-datagrid" id="dissList" data-options="rownumbers:true"  title = "站点列表" style="width:350px;height:250px">
                                    <thead>
                                    <tr>
                                        <th data-options="field:'id',checkbox:true"></th>
                            ...
                            <td colspan="3">
                                <table class="easyui-datagrid" title = "门锁列表"  data-options="rownumbers:true"  id="locksList"  style="width:350px;height:250px">
                                    <thead>
                                    <tr>
                                        <th data-options="field:'id',checkbox:true"></th>
