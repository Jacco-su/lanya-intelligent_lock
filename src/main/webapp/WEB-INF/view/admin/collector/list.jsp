...
<%--//                        }--%>
                ...
                <%--&lt;%&ndash;function del() {&ndash;%&gt;--%>
                <%--&lt;%&ndash;var selected = infolist.datagrid('getSelected');&ndash;%&gt;--%>
                <%--&lt;%&ndash;if (selected) {&ndash;%&gt;--%>
                <%--&lt;%&ndash;$.messager.confirm('警告', '确定要删除么?', function (f) {&ndash;%&gt;--%>
                <%--&lt;%&ndash;if (f) {&ndash;%&gt;--%>
                <%--&lt;%&ndash;$.post("${basePath}/collector/delete", {"id": selected.id}, function (json) {&ndash;%&gt;--%>
                <%--&lt;%&ndash;$.messager.alert('提示', json.message);&ndash;%&gt;--%>
                <%--&lt;%&ndash;if (json.result == 1) {&ndash;%&gt;--%>
                <%--&lt;%&ndash;infolist.datagrid('reload');&ndash;%&gt;--%>
                <%--&lt;%&ndash;}&ndash;%&gt;--%>
                <%--&lt;%&ndash;}, "json");&ndash;%&gt;--%>
                <%--&lt;%&ndash;}&ndash;%&gt;--%>
                <%--&lt;%&ndash;});&ndash;%&gt;--%>
                <%--&lt;%&ndash;} else {&ndash;%&gt;--%>
                <%--&lt;%&ndash;$.messager.alert('警告', '未选中任何数据', 'warning');&ndash;%&gt;--%>
                <%--&lt;%&ndash;}&ndash;%&gt;--%>
                <%--&lt;%&ndash;}&ndash;%&gt;--%>
