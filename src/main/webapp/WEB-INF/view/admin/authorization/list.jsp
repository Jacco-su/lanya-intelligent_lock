...
<%--/td>--%>
<%--< td >--%>
<%--&lt;%&ndash;<input type="text" name="name" id="username" value="" readonly/><a class="easyui-linkbutton"&ndash;%&gt;--%>
<%--&lt;%&ndash;onclick="$('#selectArea').window('open');">选择</a>&ndash;%&gt;--%>
<%--&lt;%&ndash;<input type="hidden" name="userid" id="usercode" value=""/>&ndash;%&gt;--%>
<%--< select--%>
<%--name = "userId"--%>
<%--name = "userId"--%>
<%--style = "width:200px;"--%>
