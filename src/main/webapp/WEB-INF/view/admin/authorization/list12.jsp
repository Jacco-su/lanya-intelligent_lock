...
<%--//< option--%>
<%--//value = "" > ---请选择-- - < /option>--%>
<%--&lt;%&ndash;<c:forEach items="${userList}" var="user" varStatus="s">&ndash;%&gt;--%>
<%--//< option--%>
<%--&lt;%&ndash;value = "${user.id}"&ndash;%&gt;--%>
<%--&lt;%&ndash;<c:if test="${user.id eq seuser.id}">selected</c:if> >${user.name} < /option>&ndash;%&gt;--%>
...
<%--//< option--%>
<%--//value = "" > ---请选择-- - < /option>--%>
<%--&lt;%&ndash;<c:forEach items="${qgdisList}" var="qgdis" varStatus="s">&ndash;%&gt;--%>
<%--//< option--%>
<%--&lt;%&ndash;value = "${qgdis.id}"&ndash;%&gt;--%>
<%--&lt;%&ndash;<c:if test="${qgdis.id eq seqgdis.id}">selected</c:if> >${qgdis.name} < /option>&ndash;%&gt;--%>
<%--&lt;%&ndash;</c:forEach>&ndash;%&gt;--%>
<%--//< /select>--%>
<%--//< /td>--%>
<%--//< /tr>--%>
...
<%--//addWin = $.createWin({--%>
<%--//title: "添加",--%>
<%--&lt;%&ndash;url: '${basePath}/keyss/prAdd',&ndash;%&gt;--%>
<%--//height: 350,--%>
<%--//width: 800,--%>
<%--//buttons: [{--%>
<%--//text: '保存',--%>
...
<%--//seeWin = $.createWin({--%>
<%--//title: "详情",--%>
<%--&lt;%&ndash;url: '${basePath}/keyss/prView',&ndash;%&gt;--%>
<%--//data: 'id=' + id,--%>
<%--//height: 550,--%>
<%--//width: 800,--%>
<%--//buttons: []--%>
...
<%--//$('#tree').tree({--%>
<%--//checkbox: false,--%>
<%--&lt;%&ndash;url: '${basePath}/user/list',&ndash;%&gt;--%>
<%--//simpleDataModel: true,--%>
<%--//onBeforeExpand: function (node, param) {--%>
<%--&lt;%&ndash;$('#tree').tree('options').url = "${basePath}/areainfo/findAreaByParentId?parentId=" + node.id;// change the url&ndash;%&gt;--%>
<%--//return true;--%>
<%--//}--%>
<%--//});--%>
<%--//--%>
...
<%--//updateWin = $.createWin({--%>
<%--//title: "修改",--%>
<%--&lt;%&ndash;url: '${basePath}/keyss/prUpdate',&ndash;%&gt;--%>
<%--//data: 'id=' + id,--%>
<%--//height: 550,--%>
<%--//width: 800,--%>
<%--//buttons: [{--%>
...
<%--//if (f) {--%>
<%--&lt;%&ndash;$.post("${basePath}/keyss/delete", {"id": selected.id}, function (json) {&ndash;%&gt;--%>
