...
<head>
    ...
    <script type="text/javascript">
        ...
        function offlineAuth() {
            ...
            var collectorListRow = $("#collectorList").datagrid("getChecked");
            if(collectorListRow==""){
                $.messager.alert('警告', '请选择一个采集器', 'warning');
                return;
            }
            var authLocks="";
            var authLocksId="";
            ...
            var collectorId=collectorListRow[0].id;
            console.log(collectorListRow[0]);
            var data={
                "user.id":userId,
                "keysId":keysId,
                "authName":authName,
            ...
            <div class="easyui-panel" title="门锁->采集器" style="width:800px" id="stepThere">
                <div style="padding:10px 60px 20px 60px">
                    <table cellpadding="5">
                        <tr>
                            <td colspan="3">
                                <table class="easyui-datagrid" title = "门锁列表" id="locksList"  data-options="rownumbers:true" style="width:350px;height:250px">
                                    <thead>
                                    <tr>
                                        <th data-options="field:'id',checkbox:true"></th>
                            ...
                            <td colspan="3">
                                <table class="easyui-datagrid" id="collectorList" data-options="singleSelect:true,rownumbers:true" title = "采集器列表" style="width:350px;height:250px">
                                    ...
                                    <tr>
                                        <th data-options="field:'id',checkbox:true"></th>
                                        <th data-options="field:'ccode'" width="520px">采集器</th>
                                        <th data-options="field:'disId',hidden:true" width="520px">采集器Id</th>
                                    </tr>
                                    </thead>
                                    <tbody>
