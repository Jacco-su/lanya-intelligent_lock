...
KE.setting = {
	...
	items : [
		...
		'flash', 'media', 'advtable', 'hr', 'emoticons', 'link', 'unlink','accessory','split'
	],
	colorTable : [
...
KE.lang = {
	...
	accessory : '插入附件',
	invalidAccessory : "请输入有效的URL地址。\n只允许doc,docx,wps,xls,pdf,txt,ppt,rar,zip格式。"
};
...
KE.plugin['accessory'] = {
	    ...
	    check : function(id) {
	        ...
	        if (url.match(/\.(doc|docx|wps|xls|ppt|pdf|txt|rar|zip)$/i) == null) {
	  ...
	  {
	  case "doc":
	   img="accessory/ico/doc.png";
	  break;
	  case "xls":
	   img="accessory/ico/execl.png";
	  break;
	  case "ppt":
	   img="accessory/ico/ppt.png";
	  break;
	  case "rar":
	   img="accessory/ico/zip.png";
	  break;
	  case "zip":
	   img="accessory/ico/zip.png";
	  break;
	  case "txt":
	   img="accessory/ico/txt.png";
	  break;
	  case "pdf":
	   img="accessory/ico/pdf.png";
	  break;
	  default:
	   img="accessory/ico/attach.png";
	  }
	  var html = '<img src="'+KE.g[id].pluginsPath+ img + '" >&nbsp;';
	        html += '<a href="' + url + '" >';
	        if (!title) {
	        	var n=url.split("/");
	        	title=n[n.length-1];
