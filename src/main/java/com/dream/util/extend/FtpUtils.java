...
public class FtpUtils {
    ...
    private String ip = "218.28.166.165"; //服务器IP地址
    private String userName = "sdzdz "; //用户名
    private String userPwd = "hlxx@2017"; //密码
    private int port = 19999; //端口号
    private String path = "/zdzjpg/"; //读取文件的存放目录
