		...
		if (cell != null) {
			switch (cell.getCellType()) {
				...
				case Cell.CELL_TYPE_NUMERIC:
					...
					System.out.println(ExcelUtil.isCellDateFormatted(cell)+"XXX");
