...
/**
 * Created by taller on 2017/11/7.
 */
...
public class DateUtil {
    ...
    public static final String DATETIME_HOUR_DEFAULT_FORMAT = "yyyy-MM-dd HH";

    public static final String YYYYMMDDHHMMSS_DEFAULT_FORMAT = "yyyyMMddHHmmss";
    ...
    static {
        ...
        dateTimeHourFormat=new SimpleDateFormat(DATETIME_HOUR_DEFAULT_FORMAT);
    ...
    public static String formatDateYmdhms(Date date) {
            return new SimpleDateFormat(YYYYMMDDHHMMSS_DEFAULT_FORMAT).format(date);
    }
     ...
     * @return
     */
    public static String nextThereMonthDate() {
        Calendar c = Calendar.getInstance();
        c.setTime(new Date());
