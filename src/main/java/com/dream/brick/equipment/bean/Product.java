...
public class Product implements Serializable {
    ...
    private String jyjgmc;//产品检验区域名称
    ...
    private String attr1;//县（市）区管理区域审查意见
    ...
    private String attr4;//省辖市<br/>管理区域<br/>初审意见<br/>
    private String atime4 ;//签字日期4
    private String attr5;//外省企业<br/>省级<br/>管理区域<br/>审核意见
